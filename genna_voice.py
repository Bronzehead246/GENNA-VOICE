 ...
 ```python                                                                                                     
   ...
   class GENNAVoiceTermux:                                                                                     
       ...
       def check_microphone(self):                                                                             
           result = subprocess.run(['which', 'termux-microphone'], capture_output=True)                        
       ...
       def send_to_openclaw(self, text):                                                                       
           responses = {                                                                                       
               ...
               "how are you": "Running smooth on Termux, Cally. Ready to help.",                               
               "what can you do": "I can search, manage files, run commands, and automate tasks.",             
           ...
           while running:                                                                                      
               try:                                                                                            
                   ...
                   if text:                                                                                    
                       ...
                       elif any(cmd in text for cmd in ["shutdown", "exit", "quit"]):                          
       ...
       def handle_command(self):                                                                               
           ...
           if command:                                                                                         
               if any(cmd in command for cmd in ["shutdown", "exit", "quit", "stop"]):                         
